...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#pass_box').dialog({      //this is main codes for dialog box 2 which id is box1 ( Add Subject )
			show:"bounce",
			hide:"fold",
			width:440,
			autoOpen: false,
...
<body>
	...
	<iframe src="/OnlineXam/admin/list.php" scrolling="no" width="20%" height="350" name="f1"></iframe>
	  <iframe src="/OnlineXam/admin/admin_info.php" scrolling="yes" width="79%" height="350" name="f2"></iframe> 
   ...
   if(document.form1.oldpassword.value=="")
	...
	if(document.form1.confpassword.value=="")
	{
		...
		return false;
        	...
        	<form  id="pass_box" method="post" name="pass_box" action="/OnlineXam/admin/change_pass.php" title="Change Password">
