...
<?php
$x=0;
$select=mysql_query("select * from mst_user where type like 'user'");
...
echo "<table border='1'>
	...
	<th>Phone</th>
	<th>Email</th>
	<th colspan='2'>Total Student:" . $num_rows. "</th>
	</tr>";
...
{
?>
<a href="/OnlineXam/admin/Action_Student.php?status=<?php echo $id;?>" 
