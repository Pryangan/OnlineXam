...
$num_rows = mysql_num_rows($result);
	...
	while($record=mysql_fetch_array($result)){
		...
		?>
		<td height="40" bgcolor="<?php echo $col; ?>"> <a href="\OnlineXam\admin\Delete_test.php?id=<?php echo $id; ?>" onClick="return confirm('Are you sure you wish to delete this Record?');" id="delete" class="ui-state-default ui-corner-all">
            <span class="ui-icon ui-icon-trash" title="Delete"></span></a></td>
		<td><a href="\OnlineXam\admin\update_Test.php?id=<?php echo $id; ?>" class="ui-state-default ui-corner-all" id="edit"><span class="ui-icon ui-icon-scissors" title="Edit"></span></a></td>
        <?php
		echo "</tr>";
	}
	echo "</table>";
